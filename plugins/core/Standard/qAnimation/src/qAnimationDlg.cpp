	...
	, m_smoothTrajectoryReversed(nullptr)
{
	...
	connect ( autoStepDurationCheckBox,	SIGNAL( toggled(bool) ),			this, SLOT( onAutoStepsDurationToggled(bool) ) );
	connect ( smoothTrajectoryGroupBox,	SIGNAL( toggled(bool) ),			this, SLOT( onSmoothTrajectoryToggled(bool) ) );
	connect ( smoothRatioDoubleSpinBox, SIGNAL( valueChanged(double) ),		this, SLOT( onSmoothRatioChanged(double) ) );
